...
def get_conversational_chain():
    ...
    provided context just provide a answer in terms of a Financial perspective, don't provide the wrong answer\n\n
    Context:\n {context}?\n
    Question: \n{question}\n
...
def main():
    st.set_page_config("Ask Finance")
    st.header("Ask your finance docs")
